...
## A note about Pandadocs API documentation
Pandadocs API docs don't seem updated very often. Support sent this link which seems like an autogenerated doc for the latest version.
https://openapi.pandadoc.com/

To subscribe to webhooks:
```
POST https://api.pandadoc.com/public/v1/webhook-subscriptions
Authorization: API-Key <token>
Content-Type: application/json

{
	"name": "My Fun Webhook",
	"url": "https://some-subdomain.ngrok.io/pandadoc/webhook/PXFMVEMQ/",
	"payload": [
		"fields", "products", "metadata", "tokens", "pricing"
	],
	"triggers": [
